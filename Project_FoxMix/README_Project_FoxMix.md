...
<p align="center">
  <img src="docs/images/music_selector.png" alt="Seletor de músicas — Deck 1 e Deck 2" width="400"/>
</p>
...
<p align="center">
  <img src="docs/images/vibrato.png" alt="Painel de Vibrato" width="300"/>
</p>
...
```python
# Create time vector based on number of samples and sample rate
t = np.arange(len(data)) / samplerate

# Generate sine wave modulation signal (depth = amplitude, rate = speed in Hz)
vibrato_modulation = vibrato_depth * np.sin(2 * np.pi * vibrato_rate * t)

# Shift time axis by modulation to create pitch fluctuation effect
new_time = t + vibrato_modulation

# Clamp values to avoid reading outside the audio buffer
new_time = np.clip(new_time, 0, len(data) / samplerate)

# Resample signal at shifted time positions using linear interpolation
...
<p align="center">
  <img src="docs/images/reverb.png" alt="Painel de Reverb" width="340"/>
</p>
